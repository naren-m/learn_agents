...
"""
=============================================================================
LANGGRAPH AGENT (SIMPLE) - Understanding Graph-Based Agents
=============================================================================

This script demonstrates the LangGraph agent concept using a simple
procedural workflow - ideal for learning the fundamentals.
...
if __name__ == "__main__":
    print("=" * 60)
    print("LANGGRAPH AGENT DEMO (SIMPLE PROCEDURAL VERSION)")
    print("=" * 60)
